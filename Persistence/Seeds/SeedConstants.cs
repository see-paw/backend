...
internal static class SeedConstants
{
    ...
    public const string Favorite4Id = "fav00000-0000-0000-0000-000000000004";
    ...
    // ======== ACTIVITY IDS ========
    // Main activities (slots tests)
    public const string ActivityAId = "activity-seed-a";
    public const string ActivityBId = "activity-seed-b";
    public const string ActivityCId = "activity-seed-c";
    public const string ActivityDId = "activity-seed-d";
    public const string ActivityEId = "activity-seed-e";
    public const string ActivityFId = "activity-seed-f";
    public const string ActivityGId = "activity-seed-g";
    public const string ActivityHId = "activity-seed-h";
    public const string ActivityIId = "activity-seed-i";
    public const string ActivityJId = "activity-seed-j";
    public const string ActivityKId = "activity-seed-k";

    // Cancel fostering test activities
    public const string ActivityC1Id = "d0b1c2d3-e4f5-4a6b-7c8d-9e0f1a2b3c4d";
    public const string ActivityC2Id = "e1c2d3e4-f5a6-4b7c-8d9e-0f1a2b3c4d5e";
    public const string ActivityC3Id = "f2d3e4f5-a6b7-4c8d-9e0f-1a2b3c4d5e6f";
    public const string ActivityC4Id = "a3e4f5a6-b7c8-4d9e-0f1a-2b3c4d5e6f7a";
    public const string ActivityC5Id = "b4f5a6b7-c8d9-4e0f-1a2b-3c4d5e6f7a8b";
    public const string ActivityC6Id = "c5a6b7c8-d9e0-4f1a-2b3c-4d5e6f7a8b9c";
    public const string ActivityC7Id = "d6b7c8d9-e0f1-4a2b-3c4d-5e6f7a8b9c0d";
    public const string ActivityC8Id = "e7c8d9e0-f1a2-4b3c-4d5e-6f7a8b9c0d1e";
    
    // ======== FOSTERING IDS ========
    // Main fosterings
    public const string Fostering1Id = "f0000000-0000-0000-0000-000000000001";
    public const string Fostering2Id = "f0000000-0000-0000-0000-000000000002";
    public const string Fostering3Id = "f0000000-0000-0000-0000-000000000003";

    // Fostering test fosterings
    public const string FosteringF1Id = "a3b4c5d6-e7f8-4a7b-0c1d-2e3f4a5b6c7d";
    public const string FosteringF2Id = "b4c5d6e7-f8a9-4b8c-1d2e-3f4a5b6c7d8e";
    public const string FosteringF3Id = "fostering-003";
    public const string FosteringInactiveId = "c5d6e7f8-a9b0-4c9d-2e3f-4a5b6c7d8e9f";
    public const string FosteringWithSlotId = "d6e7f8a9-b0c1-4d0e-3f4a-5b6c7d8e9f0a";
    public const string FosteringWithActivityId = "e7f8a9b0-c1d2-4e1f-4a5b-6c7d8e9f0a1b";
    public const string FosteringShelterTestId = "f9a0b1c2-d3e4-4f5a-6b7c-8d9e0f1a2b3c";

    // Cancel fostering test fosterings
    public const string FosteringC1Id = "c3a4b5c6-d7e8-4f9a-0b1c-2d3e4f5a6b7c";
    public const string FosteringC2Id = "d4b5c6d7-e8f9-4a0b-1c2d-3e4f5a6b7c8d";
    public const string FosteringC3Id = "e5c6d7e8-f9a0-4b1c-2d3e-4f5a6b7c8d9e";
    public const string FosteringC4Id = "f6d7e8f9-a0b1-4c2d-3e4f-5a6b7c8d9e0f";
    public const string FosteringC5Id = "a7e8f9a0-b1c2-4d3e-4f5a-6b7c8d9e0f1a";
    public const string FosteringC6Id = "b8f9a0b1-c2d3-4e4f-5a6b-7c8d9e0f1a2b";
    public const string FosteringC8Id = "c9a0b1c2-d3e4-4f5a-6b7c-8d9e0f1a2b3c";

    // ======== ACTIVITY SLOT IDS ========
    // Normal slots
    public const string SlotNormal1 = "slot-normal-1";
    public const string SlotNormal2 = "slot-normal-2";
    public const string SlotNormal3 = "slot-normal-3";
    public const string SlotNormal4 = "slot-normal-4";
    public const string SlotNormal5 = "slot-normal-5";

    // Edge case slots
    public const string SlotEdgeStartBefore = "slot-edge-start-before";
    public const string SlotEdgeEndAfter = "slot-edge-end-after";
    public const string SlotEdgeExactOpen = "slot-edge-exact-open";
    public const string SlotEdgeExactClose = "slot-edge-exact-close";

    // Multi-day slots
    public const string SlotMultiDay1 = "slot-multiday-1";
    public const string SlotMultiDay2 = "slot-multiday-2";

    // Short slots
    public const string SlotShort1 = "slot-short-1";
    public const string SlotShort2 = "slot-short-2";

    // Overlap slots
    public const string SlotOverlap1 = "slot-overlap-1";
    public const string SlotOverlap2 = "slot-overlap-2";

    // Same day slots
    public const string SlotSameDay1 = "slot-same-day-1";
    public const string SlotSameDay2 = "slot-same-day-2";
    public const string SlotSameDay3 = "slot-same-day-3";

    // Cancel fostering test slots
    public const string SlotC1 = "f8d9e0f1-a2b3-4c4d-5e6f-7a8b9c0d1e2f";
    public const string SlotC2 = "a9e0f1a2-b3c4-4d5e-6f7a-8b9c0d1e2f3a";
    public const string SlotC3 = "b0f1a2b3-c4d5-4e6f-7a8b-9c0d1e2f3a4b";
    public const string SlotC4 = "c1a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c";
    public const string SlotC5 = "d2b3c4d5-e6f7-4a8b-9c0d-1e2f3a4b5c6d";
    public const string SlotC6 = "e3c4d5e6-f7a8-4b9c-0d1e-2f3a4b5c6d7e";
    public const string SlotC7 = "f4d5e6f7-a8b9-4c0d-1e2f-3a4b5c6d7e8f";
    public const string SlotC8 = "a5e6f7a8-b9c0-4d1e-2f3a-4b5c6d7e8f9a";

    // ======== SHELTER UNAVAILABILITY SLOT IDS ========
    public const string UnavShort = "unav-short";
    public const string UnavHalfDay = "unav-half-day";
    public const string UnavFullDay = "unav-full-day";
    public const string UnavWeek = "unav-week";
    public const string UnavMultiDay = "unav-multi-day";
    public const string UnavBeforeOpen = "unav-before-open";
    public const string UnavAfterClose = "unav-after-close";
    public const string UnavExactHours = "unav-exact-hours";
    public const string UnavMidnight = "unav-midnight";

    // ======== GET FOSTERINGS TEST SLOT IDS ========
    public const string SlotMax001 = "slot-max-001";
    public const string SlotMax002 = "slot-max-002";
    public const string SlotMax003 = "slot-max-003";
    public const string SlotLuna001 = "slot-luna-001";
    public const string SlotLuna002 = "slot-luna-002";
    public const string SlotLuna003 = "slot-luna-003";
    public const string SlotCharlie001 = "slot-charlie-001";
    public const string SlotCharlie002 = "slot-charlie-002";
    public const string SlotCharlie003 = "slot-charlie-003";
    public const string SlotBella001 = "slot-bella-001";
    public const string SlotBella002 = "slot-bella-002";
    public const string SlotBella003 = "slot-bella-003";
    public const string SlotRocky001 = "slot-rocky-001";
    public const string SlotRocky002 = "slot-rocky-002";
    public const string SlotRocky003 = "slot-rocky-003";
    public const string SlotMaxPast001 = "slot-max-past-001";
    public const string SlotCancelled001 = "slot-cancelled-001";
    public const string SlotMaxAvailable001 = "slot-max-available-001";

    // ======== GET FOSTERINGS TEST ACTIVITY IDS ========
    public const string ActivityMax001 = "activity-max-001";
    public const string ActivityLuna001 = "activity-luna-001";
    public const string ActivityCharlie001 = "activity-charlie-001";
    public const string ActivityBella001 = "activity-bella-001";
    public const string ActivityRocky001 = "activity-rocky-001";
    public const string ActivityCancelled001 = "activity-cancelled-001";
}