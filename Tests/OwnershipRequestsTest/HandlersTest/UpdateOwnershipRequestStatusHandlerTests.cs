...
public class UpdateOwnershipRequestStatusHandlerTests
{
    ...
    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldReturnForbidden_WhenUserIsNotShelterAdmin()
    {
    ...
    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldReturnNotFound_WhenRequestDoesNotExist()
    {
    ...
    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldReturnForbidden_WhenAnimalNotInAdminShelter()
    {
        var shelterId = Guid.NewGuid().ToString();
    ...
    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldReturnBadRequest_WhenStatusIsApproved()
    {
        var shelterId = Guid.NewGuid().ToString();

        var (animal, request, user, shelter) = await SeedOwnershipRequestAsync(
            OwnershipStatus.Approved, // Cannot transition to Analysing
            AnimalState.Available,
            shelterId);
    ...
    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldReturnBadRequest_WhenStatusIsAlreadyAnalysing()
    {
        var shelterId = Guid.NewGuid().ToString();

        var (animal, request, user, shelter) = await SeedOwnershipRequestAsync(
            OwnershipStatus.Analysing, // Already Analysing
            AnimalState.Available,
            shelterId);
    ...
    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldReturnBadRequest_WhenAnimalHasOwner()
    {
        var shelterId = Guid.NewGuid().ToString();

        var (animal, request, user, shelter) = await SeedOwnershipRequestAsync(
            OwnershipStatus.Pending,
            AnimalState.HasOwner, // Animal has owner
            shelterId);
    ...
    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldReturnBadRequest_WhenAnimalIsInactive()
    {
        var shelterId = Guid.NewGuid().ToString();

        var (animal, request, user, shelter) = await SeedOwnershipRequestAsync(
            OwnershipStatus.Pending,
            AnimalState.Inactive, // Animal is inactive
            shelterId);
    ...
    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldReturnSuccess_WhenTransitionFromPending()
    {
        var shelterId = Guid.NewGuid().ToString();
    ...
    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldReturnSuccess_WhenTransitionFromRejected()
    {
        var shelterId = Guid.NewGuid().ToString();
    ...
    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldUpdateStatusToAnalysing()
    {
        var shelterId = Guid.NewGuid().ToString();
        ...
        Assert.Equal(OwnershipStatus.Analysing, updatedRequest!.Status);
    }

    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldSetUpdatedAtTimestamp()
    {
        var shelterId = Guid.NewGuid().ToString();
    ...
    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldSetRequestInfo_WhenProvided()
    {
        var shelterId = Guid.NewGuid().ToString();
        ...
        var updatedRequest = await _context.OwnershipRequests.FindAsync(request.Id);
        Assert.Equal(requestInfo, updatedRequest!.RequestInfo);
    }

    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldNotSetRequestInfo_WhenNotProvided()
    {
        var shelterId = Guid.NewGuid().ToString();
    ...
    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldReturnRequestWithAnimalIncluded()
    {
        var shelterId = Guid.NewGuid().ToString();
    ...
    [Fact]
    public async Task UpdateOwnershipRequestStatus_ShouldReturnRequestWithUserIncluded()
    {
        var shelterId = Guid.NewGuid().ToString();
