...
namespace Tests
{
    public class CreateAnimalTests
    {
        ...
        [InlineData("ThisIsAnExtremelyLongNameThatExceedsTheMaximumAllowedCharacterLimitForAnimalNamesInTheDatabase")] // too long
        ...
        // test a representative sample of valid breed values across different species because Breed enum has many values

        [Theory]
        [InlineData(Breed.Labrador)]
        [InlineData(Breed.GermanShepherd)]
        [InlineData(Breed.Siamese)]
        [InlineData(Breed.Persian)]
        [InlineData(Breed.Unknown)]
        public void AnimalBreedValid(Breed breed)
        {
            var dto = CreateValidAnimalDTO();
            dto.Breed = breed;
        ...
        [InlineData("")] // empty string
        [InlineData("   ")] // only spaces
        public void AnimalMainImageUrlNullOrEmpty(string url)
        {
            var dto = CreateValidAnimalDTO();
        ...
        [InlineData("example")] // invalid format
        public void AnimalMainImageUrlInvalid(string url)
        {
            var dto = CreateValidAnimalDTO();
            dto.MainImageUrl = url;
        ...
        [InlineData("https://www.example.com/path/to/image.png")]
        [InlineData("http://example.com/animal.jpeg")]
        public void AnimalMainImageUrlValid(string url)
        {
            var dto = CreateValidAnimalDTO();
            dto.MainImageUrl = url;
        ...
        private CreateAnimalDTO CreateValidAnimalDTO()
        {
